          ...
          <div class="row nav">    
            <div class="col-md-4"></div>
             <div class="col-md-8 col-xs-12" style="margin: 0px;padding: 0px;">
              ...
              <div  href="#tab2" data-toggle="tab" class="col-md-3 col-xs-4 well"><i class="fa fa-file fa-lg"  title="" data-toggle="tooltip" data-placement="bottom" data-original-title="lectures uploaded"></i> 26</div>
              <div href="#tab3" data-toggle="tab" class="col-md-3 col-xs-4 well" ><i class="fa fa-user fa-lg" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="Follower"></i> 14</div>
