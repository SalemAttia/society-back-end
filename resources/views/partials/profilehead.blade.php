         ...
         <!-- head of profile  -->
           <div class="row panel">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
               ...
               <img class="img-thumbnail picture" src="{{asset(Auth::user()->avatar)}}">
               @else
          ...
          <div class="row nav">    
            ...
            <div class="col-md-8 col-sm-12 col-xs-12" style="margin: 0px;padding: 0px;">
              ...
              <div href="#tab2" data-toggle="tab" class="col-md-3 col-sm-4 col-xs-4 well" ><i class="fa fa-user fa-lg" title="" data-toggle="tooltip" data-placement="bottom" data-original-title="Follower"></i>{{$numfo}}</div>
